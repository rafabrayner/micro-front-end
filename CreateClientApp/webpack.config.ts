...
const config: Configuration = {
  ...
  output: {
    ...
    filename: 'bundle.js',
    publicPath: 'http://localhost:9002/', // Base path for all the assets within the application. Make possible to access routes direct from browser
  },
  resolve: {
